...
if __name__ == '__main__':
    folderShp = \
        ur'R:\OIIS_KR5\_PROJEKTY 2020\20029-00_Mapy_Budowle_cz2\07.GIS\4_Opracowanie_baz_danych\_DO PRZEKAZANIA\_26_budowli\BUDOWLE PIETRZACE\OBSZARY DORZECZA\OD WISŁY\MRP'

    geodatabaseSource = \
        r'C:\robo\URBAN\MODELE\MLYNOWKA\2_MODEL\MLYNOWKA_W0.gdb'

    geodatabaseFinal = \
        r'C:\robo\URBAN\MODELE\MLYNOWKA\2_MODEL\MLYNOWKA_W0_v01.gdb'

    loadGdb(geodatabaseSource, geodatabaseFinal)