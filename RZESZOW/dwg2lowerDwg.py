...
if __name__ == '__main__':
    input_folder_dwg = r"C:\robo\_warstwy_tymczasowe\CAD"
    output_folder_dwg = r"C:\robo\_warstwy_tymczasowe\CAD\wynik"
    saveDwgVersion(input_folder_dwg, output_folder_dwg, 'DWG_R2013')
