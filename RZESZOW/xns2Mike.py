...
def ProcessLine(river, topo, chain, xsID, selLayer, selRough, line_geometry, outFile, fldKm, fldRKod, fldRzedna,
    ...
    clp_raster = "in_memory\\clp_raster"
    ...
    clp_RoughR = "in_memory\\clp_RoughR"
...
if __name__ == '__main__':
    lPrzekroje = \
        r'P:\02_Pracownicy\Monika\01.Puławska\02.GIS\13.Przekroje_pkt_korytowe_do_generacji\Przekroje_Pulawska_xns\Model_1\cieki\Kanał_Grabowski\test.gdb\Kanal_Grabowski_przekroje_DS'
    fldKm = 'KM'
    fldRivername = 'nazwa'
    fldTopo = '2022'
    fldXsId = 'NR'
    rNMT = r'P:\02_Pracownicy\Mariusz\PULAWSKA\NMT\NMT.gdb\NMT_PULAWSKA'
    lRoughness = r'P:\02_Pracownicy\Monika\01.Puławska\02.GIS\11.Mapa_szorstkosc\Szorstkosc_Pulawska.shp'
    fldN = 'n_aMZP'
    lPomiary = \
        r'P:\02_Pracownicy\Monika\01.Puławska\02.GIS\13.Przekroje_pkt_korytowe_do_generacji\Przekroje_Pulawska_xns\Model_1\cieki\Kanał_Grabowski\test.gdb\Kanal_Grabowski_DS'
    fldRzedna = 'Z'
    fldRKod = ' '
    outFile = \
        r'P:\02_Pracownicy\Monika\01.Puławska\02.GIS\13.Przekroje_pkt_korytowe_do_generacji\Przekroje_Pulawska_xns\Model_1\cieki\Kanał_Grabowski\Kanal Grabowski_DS4.txt'
    tolerancja = '5'
    strefyN = True
